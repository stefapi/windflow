...
class TestDeploymentService:
    ...
    async def test_create_deployment(
        ...
        deployment_data = DeploymentCreate(
            ...
            config={"version": "3.8", "services": {"web": {"image": "nginx:latest"}}},
            variables={"port": 8080},
        )
    ...
    async def test_get_by_id_not_found(self, db_session: AsyncSession):
        ...
        deployment = await DeploymentService.get_by_id(db_session, "non-existent-id")
    ...
    async def test_list_all_with_pagination(
        ...
        deployments = await DeploymentService.list_all(db_session, skip=1, limit=2)
